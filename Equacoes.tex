...
\begin{enumerate}
		...
		\item O módulo de um número, ou valor absoluto do número, é o valor dele sem o sinal. Assim $|2| = |-2| = 2$. Calcule:
		\begin{enumerate}
		% first column
		\begin{multicols}{2}
			\item $|3| = $
		...
		\item Sendo $a$ um número entre 0 e 1, expresse o resultado sem usar módulo
		\begin{enumerate}
		% first column
		\begin{multicols}{2}
			\item exemplo: $|-a| = a$
		...
		\item Sendo $b$ um número entre -5 e -6, expresse o resultado sem usar módulo
		\begin{enumerate}
		% first column
		\begin{multicols}{2}
			\item $|b| = $
		...
		\item Resolva as seguintes equações envolvendo módulos.
		\begin{enumerate}
		% first column
		\begin{multicols}{2}
			\item exemplo: $|x| = 3$. solução: $ x=3$ ou $x=-3$.
			\item $|3| = x$
			\item $|x| = 3$
			\item $|-4| = x$
			\item $|x-1| = \frac{2}{3}$
